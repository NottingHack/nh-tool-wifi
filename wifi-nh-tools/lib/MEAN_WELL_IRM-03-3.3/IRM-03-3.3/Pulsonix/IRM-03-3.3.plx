...
(library Library_1
	...
	(symbolDef "IRM-03-3.3" (originalName "IRM-03-3.3")
	...
	(compDef "IRM-03-3.3" (originalName "IRM-03-3.3") (compHeader (numPins 5) (numParts 1) (refDesPrefix PS)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "IRM-03-3.3"))
		...
		(attr "<Hyperlink>" "https://www.meanwell.com/Upload/PDF/IRM-03/IRM-03-SPEC.PDF")
		(attr "<Component Height>" "15.5")
		(attr "<STEP Filename>" "IRM-03-3.3.stp")
		(attr "<STEP Offsets>" "X=15.24;Y=8.9;Z=0.32")
