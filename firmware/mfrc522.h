...
public:
	...
	void PCD_WriteRegister(PCD_Register reg, size_t count, uint8_t *values);
	...
	StatusCode PCD_CalculateCRC(uint8_t *data, size_t length, uint8_t *result);
	...
	/////////////////////////////////////////////////////////////////////////////////////
	StatusCode PCD_TransceiveData(uint8_t *sendData, size_t sendLen, uint8_t *backData, size_t *backLen, uint8_t *validBits = nullptr, uint8_t rxAlign = 0, bool checkCRC = false);
	StatusCode PCD_CommunicateWithPICC(uint8_t command, uint8_t waitIRq, uint8_t *sendData, size_t sendLen, uint8_t *backData = nullptr, size_t *backLen = nullptr, uint8_t *validBits = nullptr, uint8_t rxAlign = 0, bool checkCRC = false);
	StatusCode PICC_RequestA(uint8_t *bufferATQA, size_t *bufferSize);
	StatusCode PICC_WakeupA(uint8_t *bufferATQA, size_t *bufferSize);
	StatusCode PICC_REQA_or_WUPA(uint8_t command, uint8_t *bufferATQA, size_t *bufferSize);
	...
	StatusCode MIFARE_Read(uint8_t blockAddr, uint8_t *buffer, size_t *bufferSize);
	StatusCode MIFARE_Write(uint8_t blockAddr, uint8_t *buffer, size_t bufferSize);
	StatusCode MIFARE_Ultralight_Write(uint8_t page, uint8_t *buffer, size_t bufferSize);
	...
	// Support functions
	/////////////////////////////////////////////////////////////////////////////////////
	StatusCode PCD_MIFARE_Transceive(uint8_t *sendData, size_t sendLen, bool acceptTimeout = false);
	...
	bool MIFARE_SetUid(uint8_t *newUid, size_t uidSize, bool logErrors);
